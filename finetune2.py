...
def get_args():
    ...
    parser.add_argument('--save_path', default='./exp/final', type=str, metavar='PATH',
                        help='path to save dir (default: none)')
    parser.add_argument('--finetune', default='./exp/channel_prune/pruned.pth.tar', type=str, metavar='PATH',
...
model = ResNet_v2_channel(depth=config.depth, block_pruning=block_pruning, block_cfg=checkpoint['block_cfg'],
                          channel_cfg=checkpoint['channel_cfg'], num_classes=config.num_classes)
